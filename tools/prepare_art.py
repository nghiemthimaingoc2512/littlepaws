...
def main():
    ...
    # The manifest is imported by the app, so it lives in src; Vite refuses
    # JavaScript imports out of the public directory.
    (ROOT / "web" / "src" / "art-manifest.json").write_text(json.dumps(manifest, indent=2) + "\n")
